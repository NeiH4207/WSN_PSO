...
class Node(object):
  def __init__(self, id, parent = None):
    self.pos_x, self.pos_y = np.random.uniform(cf.AREA_WIDTH), np.random.uniform(cf.AREA_LENGTH)
  ...
  def clustering(self, algorithm):
    self.clusters = algorithm.cluster(self)
